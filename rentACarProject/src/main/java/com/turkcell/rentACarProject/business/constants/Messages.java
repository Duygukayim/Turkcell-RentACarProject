...
public class Messages {
	...
	public static final String CREDITCARDFOUND = "credit.card.found";
	...
	public static final String CARRENTALFOUND = "rental.found";
	public static final String CARRENTALNOTFOUND = "rental.not.found";
	public static final String CARRENTALLIST = "rentals.listed";
	public static final String CARRENTALADDFORCORPORATE = "rental.added";
	public static final String CARRENTALADDFORINDIVIDUAL = "rental.added";
	public static final String CARRENTALUPDATE = "rental.updated";
	public static final String CARRENTALDELETE = "rental.deleted";
	public static final String CARRENTALDATEERROR = "rental.date.error";
	public static final String CARRENTALDATESUCCESS = "rental.date.success";
	public static final String CARRENTALMAINTENANCEERROR = "rented.car.is.under.maintenance";
	public static final String CARRENTALERROR = "rental.car.is.not.returned.yet";
	
	public static final String CARMAINTENANCENOTFOUND="car.maintenance.not.found";
	public static final String CARMAINTENANCEFOUND="car.maintenance.found";
	...
	public static final String CARMAINTENANCEERROR = "car.is.still.under.maintanence";
	...
	public static final String CARALREADYEXISTS = "car.exists";
	public static final String CARSORTED = "car.sorted";
	public static final String CARPAGED = "car.paged";
	public static final String CARDAILYPRICEERROR = "car.daily.price.error";
	...
	public static final String BRANDALREADYEXISTS = "brand.exists";
	...
	public static final String POSISBANK = "payment.with.IsBank";
	public static final String POSISBANKERROR = "payment.with.IsBank.fail";
	public static final String POSHALKBANK = "payment.with.HalkBank";
	public static final String POSHALKBANKERROR = "payment.with.HalkBank.fail";
	...
	public static final String CUSTOMERFOUND = "customer.found";
