...
public class InvoicesController {
	...
	@GetMapping("/getById")
	public DataResult<GetInvoiceDto> get(@RequestParam int id) {
	...
	public DataResult<List<ListInvoiceDto>> getByBetweenDates(@RequestParam LocalDate endDate, @RequestParam LocalDate startDate) {
